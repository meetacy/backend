...
import app.meetacy.backend.usecase.integration.meetings.usecaseGetMeetingsListRepository
...
fun startMockEndpoints(
    ...
    startEndpoints(
        ...
        meetingsDependencies = MeetingsDependencies(
            meetingsProvider = usecaseGetMeetingsListRepository(mockGetMeetingsListUsecase()),
