...
object Deps {
    ...
    object Projects {
        ...
        const val DatabaseInvitations = ":database:invitations"
        const val DatabaseInvitationsIntegration = ":database:invitations:integrations"
        const val DatabaseUsers = ":database:users"
        const val DatabaseUsersIntegrations = ":database:users:integrations"
        const val DatabaseTypes = ":database:types"
        const val DatabaseTypesIntegrations = ":database:types:integrations"
        const val DatabaseFiles = ":database:files"
        const val DatabaseFilesIntegrations = ":database:files:integrations"
        const val DatabaseAuth = ":database:auth"
        const val DatabaseAuthIntegrations = ":database:auth:integrations"
        const val DatabaseEmail = ":database:email"
        const val DatabaseEmailIntegrations = ":database:email:integrations"
        const val DatabaseFriends = ":database:friends"
        const val DatabaseFriendsIntegrations = ":database:friends:integrations"
        const val DatabaseNotifications = ":database:notifications"
        const val DatabaseNotificationsIntegrations = ":database:notifications:integrations"
        const val DatabaseLocation = ":database:location"
        const val DatabaseLocationIntegrations = ":database:location:integrations"
        const val DatabaseInit = ":database:init"
        const val DatabaseMigrations = ":database:migrations"
