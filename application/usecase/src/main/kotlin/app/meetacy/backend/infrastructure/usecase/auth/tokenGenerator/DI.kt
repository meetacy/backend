...
import app.meetacy.backend.feature.auth.usecase.integration.UsecaseTokenGenerateRepository
...
fun DIBuilder.tokenGenerator() {
    val tokenGenerateRepository by singleton<TokenGenerateRepository> {
        UsecaseTokenGenerateRepository(
            usecase = app.meetacy.backend.feature.auth.usecase.auth.GenerateTokenUsecase(
