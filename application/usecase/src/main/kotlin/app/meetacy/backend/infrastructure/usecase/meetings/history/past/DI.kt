package app.meetacy.backend.infrastructure.usecase.meetings.history.past

import app.meetacy.backend.endpoint.meetings.history.past.ListMeetingsPastRepository
import app.meetacy.backend.feature.auth.usecase.integration.meetings.history.past.UsecaseListPastMeetingsRepository
