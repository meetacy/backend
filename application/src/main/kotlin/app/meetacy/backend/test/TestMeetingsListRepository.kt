...
object TestMeetingsListRepository : MeetingsListRepository {
        ...
        ListMeetingsResult.Success(
            meetings = listOf(
                ...
                Meeting(
                    ...
                    date = Date("2023-08-17T14:40:42+0100").serializable(),
                    location = Location(
                        latitude = 38.897518,
                        longitude = -77.036090
                    ).serializable(),
                ...
                Meeting(
                    ...
                    date = Date("2033-08-17T14:40:42+0100").serializable(),
                    location = Location(
                        latitude = 35.077559,
