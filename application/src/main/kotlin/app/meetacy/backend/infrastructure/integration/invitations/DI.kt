package app.meetacy.backend.infrastructure.integration.invitations

import app.meetacy.di.DI
import app.meetacy.di.builder.DIBuilder
import app.meetacy.di.dependency.Dependency
import app.meetacy.backend.endpoint.invitations.InvitationsDependencies
import app.meetacy.backend.infrastructure.integration.invitations.accept.acceptInvitationRepository
import app.meetacy.backend.infrastructure.integration.invitations.cancel.cancelInvitationRepository
import app.meetacy.backend.infrastructure.integration.invitations.create.createInvitationRepository
import app.meetacy.backend.infrastructure.integration.invitations.deny.denyInvitationRepository
