...
import app.meetacy.backend.feature.auth.usecase.integration.friends.add.UsecaseAddFriendRepository
...
import app.meetacy.backend.feature.auth.usecase.integration.friends.location.stream.UsecaseStreamLocationRepository
import app.meetacy.backend.feature.auth.usecase.integration.invitations.accept.UsecaseAcceptInvitationRepository
import app.meetacy.backend.feature.auth.usecase.integration.invitations.cancel.UsecaseCancelInvitationRepository
import app.meetacy.backend.feature.auth.usecase.integration.invitations.create.UsecaseCreateInvitationRepository
import app.meetacy.backend.feature.auth.usecase.integration.invitations.deny.UsecaseDenyInvitationRepository
import app.meetacy.backend.feature.auth.usecase.integration.notifications.get.UsecaseListNotificationsRepository
import app.meetacy.backend.feature.auth.usecase.integration.notifications.read.UsecaseReadNotificationsRepository
...
import app.meetacy.backend.feature.usecase.integration.updates.stream.StreamUpdatesRepository
