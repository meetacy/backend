package app.meetacy.backend.application.database.friends
...
import app.meetacy.backend.application.database.friends.add.addFriend
import app.meetacy.backend.application.database.friends.delete.deleteFriend
import app.meetacy.backend.application.database.friends.list.listFriendsStorage
import app.meetacy.backend.application.database.friends.location.stream.locationStream
